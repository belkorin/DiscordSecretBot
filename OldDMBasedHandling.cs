...
{
    public class OldDMBasedHandling
    {
        DiscordSocketClient _client;
        Database _database;

        Dictionary<ulong, MessageInfo> _pendingMessages = new Dictionary<ulong, MessageInfo>();
        public OldDMBasedHandling(Database database, DiscordSocketClient client)
        {
            _client = client;
            _database = database;
        }
        ...
        public bool IsUserBanned(SocketUser author, ulong guildId)
        {
        ...
        public bool UserIsInValidRole(SocketUser author, ulong guildId)
        {
